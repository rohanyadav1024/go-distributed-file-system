...
const (
	...
	NodeService_CopyChunk_FullMethodName = "/node.NodeService/CopyChunk"
)
...
func (c *nodeServiceClient) CopyChunk(ctx context.Context, in *CopyChunkRequest, opts ...grpc.CallOption) (*CopyChunkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CopyChunkResponse)
	err := c.cc.Invoke(ctx, NodeService_CopyChunk_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNodeServiceServer) CopyChunk(context.Context, *CopyChunkRequest) (*CopyChunkResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CopyChunk not implemented")
}
...
func _NodeService_CopyChunk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CopyChunkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NodeServiceServer).CopyChunk(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NodeService_CopyChunk_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).CopyChunk(ctx, req.(*CopyChunkRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NodeService_CopyChunk_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/protocol/node/node.proto",
}
